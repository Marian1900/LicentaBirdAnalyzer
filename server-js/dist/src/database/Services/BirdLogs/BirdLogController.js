...
exports.deleteBirdLog = exports.addBirdLog = exports.getAllBirdLogs = exports.getAllBirdLogsForUser = void 0;
const mongodb_1 = require("mongodb");
const database_js_1 = require("../database.js");
const birdLogs_1 = require("./../../models/BirdLogs/birdLogs");
const getAllBirdLogsForUser = (userId) => {
...
exports.getAllBirdLogsForUser = getAllBirdLogsForUser;
const getAllBirdLogs = () => {
    return (0, database_js_1.connectToDB)()
        .then(client => {
        const db = client.db(process.env.DATABASE_NAME);
        const collection = db.collection('BirdLog');
...
exports.getAllBirdLogs = getAllBirdLogs;
const addBirdLog = (data) => {
    return (0, database_js_1.connectToDB)()
        .then(async (client) => {
        const db = client.db(process.env.DATABASE_NAME);
        ...
        if (specie) {
            ...
            if (achievementsDictionaryEntry) {
                const currentAchievements = achievementsDictionaryEntry.achievmentsNames;
        ...
        const logForDB = new birdLogs_1.BirdLogModel(data);
        return logsCollection.insertOne(logForDB);
    });
};
exports.addBirdLog = addBirdLog;
const deleteBirdLog = (id) => {
    return (0, database_js_1.connectToDB)()
        .then(client => {
        const db = client.db(process.env.DATABASE_NAME);
        const collection = db.collection('BirdLog');
        return collection.deleteOne({ _id: new mongodb_1.ObjectId(id) });
    });
};
exports.deleteBirdLog = deleteBirdLog;
